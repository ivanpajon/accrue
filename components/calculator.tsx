...
export default function Calculator({displayName,signOutPath,signInPath}:{displayName:string;signOutPath:string;signInPath:string}) {
  ...
  useEffect(() => {
    void usePreferences.getState().refresh();
    const sync=()=>{if(document.visibilityState==='visible' && !usePreferences.getState().pending)void usePreferences.getState().retry();};
  ...
  return <TooltipProvider delayDuration={250}><div className="app-shell">
    ...
    <main className="main-container">
      ...
      <AccountStatus signInPath={signInPath} /><ConfigurationContext />
